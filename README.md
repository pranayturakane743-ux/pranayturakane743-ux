...
![Repo Stars](https://img.shields.io/github/stars/pranayturakane743-ux/Servico-India-?label=Stars%20(Sevico%20India)&style=for-the-badge&color=8B5CF6&logo=github&logoColor=white)
...
| **Repository** | [View Repository](https://github.com/pranayturakane743-ux/Servico-India-) |
...
<!-- Swap the # hrefs below for your real profile URLs -->

<div align="center">

[![LeetCode](https://img.shields.io/badge/LeetCode-6D28D9?style=for-the-badge&logo=leetcode&logoColor=white)](#)
[![GeeksforGeeks](https://img.shields.io/badge/GeeksforGeeks-4F46E5?style=for-the-badge&logo=geeksforgeeks&logoColor=white)](#)
...
*Placeholders for now — link these to your actual handles.*
...
<img src="https://raw.githubusercontent.com/pranayturakane/pranayturakane/output/github-contribution-grid-snake-dark.svg" />

</div>

<!--
One-time setup required: add the Platane/snk GitHub Action to a repo named
exactly `pranayturakane` (your special GitHub profile repo), writing its
output to an `output` branch. Guide: https://github.com/Platane/snk
Until that Action is set up and has run once, the image above will be blank.
-->
